...
class PlanesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create plane" do
    assert_difference('Plane.count') do
      post planes_url, params: { plane: { manufacturer: @plane.manufacturer, model: @plane.model, seats: @plane.seats } }
    end
  ...
  test "should update plane" do
    patch plane_url(@plane), params: { plane: { manufacturer: @plane.manufacturer, model: @plane.model, seats: @plane.seats } }
